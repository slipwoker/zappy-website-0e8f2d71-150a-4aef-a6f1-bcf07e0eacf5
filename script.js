document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleContactFormSubmit(e) {
        ...
        if (!hasErrors) {
            ...
            if (submitButton) {
                ...
                submitButton.value = submitButton.getAttribute('data-loading-text') || 'Sending...';
            }
            ...
            fetch(action, fetchOptions)
                ...
                .then(function() {
                    ...
                    if (successMessage) {
                        ...
                        tempSuccess.className = 'form-success-message';
                        tempSuccess.textContent = form.getAttribute('data-success-message') || 'Thank you! Your message has been sent.';
                        tempSuccess.style.display = 'block';
                        form.appendChild(tempSuccess);
                    }
                ...
                .catch(function(error) {
                    ...
                    if (errorMessage) {
                        ...
                        tempError.className = 'form-error-message';
                        tempError.textContent = form.getAttribute('data-error-message') || 'Something went wrong. Please try again.';
    ...
    function handleFormFieldInput(e) {
        ...
        const formErrorMessage = field.closest('form').querySelector('.form-error-message');
        if (formErrorMessage) {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('input', handleFormFieldInput);
    }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '0e8f2d71-150a-4aef-a6f1-bcf07e0eacf5',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '0e8f2d71-150a-4aef-a6f1-bcf07e0eacf5';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '0e8f2d71-150a-4aef-a6f1-bcf07e0eacf5';
